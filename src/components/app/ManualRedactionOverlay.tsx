...
export function ManualRedactionOverlay({
  ...
  return (
    <>
      ...
      {draftBox ? (
        <div
          className="border-detection-ring bg-detection/[0.18] rounded-detection absolute top-(--box-top) left-(--box-left) h-(--box-height) w-(--box-width) border-2 border-dashed"
