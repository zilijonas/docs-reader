    ...
    <Dialog onClose={closeConfirmAllExportModal} open={showConfirmAllExportModal}>
      <div className="flex flex-col gap-4">
        <div className="flex flex-col gap-1.5">
          <h2 className="type-body-lg font-semibold text-content">{copy.confirmAllExport.title}</h2>
          <p className="text-sm leading-6 text-content-muted">{copy.confirmAllExport.body}</p>
        </div>
