...
export const LONG_STREET_TOKENS = [
  ...
  'square', 'place', 'alley', 'way',
  // German
  'straße', 'strasse', 'str', 'gasse', 'weg', 'platz', 'allee', 'ring',
  'ufer', 'damm', 'steig',
  // French
  'rue', 'avenue', 'boulevard', 'place', 'chemin', 'impasse', 'quai',
  'route', 'allée', 'allee', 'cours', 'voie',
  // Spanish / Portuguese
  'calle', 'avenida', 'plaza', 'paseo', 'camino', 'carrer', 'ronda',
  'passeig', 'rua', 'travessa', 'largo', 'praça', 'praca',
  // Italian
  'via', 'viale', 'piazza', 'corso', 'vicolo', 'contrada', 'piazzale',
  'largo',
  // Dutch / Flemish
  ...
  // Lithuanian
  'gatvė', 'gatve', 'prospektas', 'alėja', 'aleja', 'skersgatvis', 'takas',
  'plentas',
  // Latvian / Estonian
  'iela', 'prospekts', 'bulvāris', 'bulvaris', 'tänav', 'tanav', 'puiestee',
  'maantee',
  // Nordic
  'gatan', 'gata', 'vägen', 'vagen', 'gade', 'vej', 'allé',
  // Czech / Slovak
  'ulice', 'třída', 'trida', 'náměstí', 'namesti', 'námestie', 'namestie',
  'nábreží',
  // Hungarian
...
export const LONG_CITY_MARKERS = [
  'miestas', 'miesto', 'miasto', 'rajonas', 'seniūnija', 'seniunija',
  'apskritis', 'stadt', 'ville', 'cedex', 'város', 'varos', 'miasteczko',
  'község', 'kozseg', 'comune', 'municipio', 'concello', 'distrikt',
  'gemeinde',
];
...
export const ADDRESS_CONNECTORS = [
  'de', 'la', 'le', 'les', 'des', 'du', 'da', 'do', 'dos', 'das', 'van',
  'von', 'der', 'den', 'al', 'del', 'y', 'e', 'und', 'et', 'of', 'the',
];
